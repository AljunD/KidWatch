...
export default function StudentProfileScreen({ navigation, route }: any) {
  // --- ONLY CHANGE: Added logic to receive the name and image ---
  const { studentName, studentImage } = route.params || { 
    studentName: 'Michelle Llander', 
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        >
          <View style={styles.imageWrapper}>
            <Image 
              source={studentImage} // Changed to dynamic image
        ...
        <View style={styles.content}>
          <View style={styles.infoCard}>
            ...
            {/* Changed value to studentName */}
            <InfoRow label="Full Name" value={studentName} icon="person-outline" color="#FF6B6B" />
